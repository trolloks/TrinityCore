...
#ifndef SCRIPT_DEFINES_ALL_GAMEOBJECT_SCRIPT_H_
#define SCRIPT_DEFINES_ALL_GAMEOBJECT_SCRIPT_H_
...
{
protected:
    AllGameObjectScript(char const* name, uint16 totalAvailableHooks = 0);

public:
    [[nodiscard]] bool IsDatabaseBound() const override { return false; }

    // Called after game object is added to world.
    virtual void OnGameObjectAddWorld(GameObject* /*go*/) { }

    // Called after game object is saved to DB.
    virtual void OnGameObjectSaveToDB(GameObject* /*go*/) { }

    // Called after game object is removed from world.
    virtual void OnGameObjectRemoveWorld(GameObject* /*go*/) { }

    // Called every game object update tick.
    virtual void OnGameObjectUpdate(GameObject* /*go*/, uint32 /*diff*/) { }

    // Called when a player opens a gossip dialog with the game object.
    [[nodiscard]] virtual bool CanGameObjectGossipHello(Player* /*player*/, GameObject* /*go*/) { return false; }

    // Called when a player selects a gossip item in the game object's gossip menu.
    [[nodiscard]] virtual bool CanGameObjectGossipSelect(Player* /*player*/, GameObject* /*go*/, uint32 /*sender*/, uint32 /*action*/) { return false; }

    // Called when a player selects a gossip with a code in the game object's gossip menu.
    ...
    // Called when a player selects a quest reward from the game object.
    ...
    // Called when a GameObjectAI object is needed for the game object.
    virtual GameObjectAI* GetGameObjectAI(GameObject* /*go*/) const { return nullptr; }
};

#endif // SCRIPT_DEFINES_ALL_GAMEOBJECT_SCRIPT_H_
