...
#ifndef SCRIPT_DEFINES_ALL_ITEM_SCRIPT_H_
#define SCRIPT_DEFINES_ALL_ITEM_SCRIPT_H_
...
{
protected:
    AllItemScript(char const* name, uint16 totalAvailableHooks = 0);
...
public:
    ...
    // Called when a player selects a code option in an item gossip window.
    virtual void OnItemGossipSelectCode(Player* /*player*/, Item* /*item*/, uint32 /*sender*/, uint32 /*action*/, char const* /*code*/) { }
};

#endif // SCRIPT_DEFINES_ALL_ITEM_SCRIPT_H_
